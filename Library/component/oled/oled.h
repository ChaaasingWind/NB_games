...
inline __attribute__((section(".sram2"))) uint8_t zero[128] = {0};
inline __attribute__((section(".sram2"))) uint8_t full[128] = {
...
inline __attribute__((section(".sram2"))) uint8_t oled_buffer[8][128];
